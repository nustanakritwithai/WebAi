...
async function requestBrowserAgentChat(messages) {
  return request("/api/typhoon/chat", { messages, temperature: 0.2, max_tokens: 4096 }, 190000);
}
