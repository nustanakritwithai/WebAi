...
const checks = [
  ...
  ["agent generation saves immediately without an Apply step", core.includes('task.status = "applying"') && core.includes("workspace.writeTaskFiles(task.id, files") && !core.includes("applyAgentFiles") && !html.includes("applyAgentFilesBtn")],
