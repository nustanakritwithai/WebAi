...
const checks = [
  ...
  ["step completion requires complete readback metadata", core.includes("readbackEvidenceForRecord") && core.includes("contentPresent") && core.includes("contentBytes") && core.includes("version: metadataComplete ? revision") && core.includes("hash && /^[a-f0-9]{64}$/") && core.includes("record.hash !== revisions[0]?.hash")],
